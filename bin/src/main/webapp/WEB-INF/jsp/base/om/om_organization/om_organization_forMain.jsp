...
<script type="text/javascript" src="${ctx}/script/base/om/om_organization/om_organization_tree.js"></script>
<script type="text/javascript">

</script>
</head>
<body>
<div class="location_box"><b>位置：</b><a href="">首页</a>&nbsp;&gt;&nbsp;<a href="">组织管理</a>&nbsp;&gt;&nbsp;<span>机构人员</span></div>
...
<%@include file="om_organization_contextMenus.jsp" %>
</body>
</html>