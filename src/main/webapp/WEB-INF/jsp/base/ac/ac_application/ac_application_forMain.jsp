...
<script type="text/javascript" src="${ctx}/script/base/ac/ac_application/ac_application_tree.js"></script>
<script type="text/javascript">

</script>
</head>
<body>
<div class="location_box"><b>位置：</b><a href="">首页</a>&nbsp;&gt;&nbsp;<a href="">权限管理</a>&nbsp;&gt;&nbsp;<span>应用功能管理</span></div>
...
<%@include file="ac_application_contextMenus.jsp" %>
</body>
</html>