...
<script type="text/javascript" src="${ctx}/script/base/om/om_group/om_group_tree.js"></script>
<script type="text/javascript">

</script>
</head>
<body>
<div class="location_box"><b>位置：</b><a href="">首页</a>&nbsp;&gt;&nbsp;<a href="">组织管理</a>&nbsp;&gt;&nbsp;<span>工作组</span></div>
...
<%@include file="om_group_contextMenus.jsp" %>
</body>
</html>